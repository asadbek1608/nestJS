...
export class Comment {
  ...
  @ManyToOne(() => Auth, (user) => user.comments, {onDelete: "CASCADE", onUpdate: "CASCADE"})
  author: Auth;

  @ManyToOne(() => Comment, (comment) => comment.replies, {nullable: true, onDelete: "CASCADE", onUpdate: "CASCADE"})
  parent: Auth;

  @ManyToOne(() => Comment, (comment) => comment.parent, {nullable: true, onDelete: "CASCADE", onUpdate: "CASCADE"})
  replies: Comment[];
}
